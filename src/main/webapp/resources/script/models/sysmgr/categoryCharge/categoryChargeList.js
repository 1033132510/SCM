...
var CategoryChargeObject = {
		...
		toEdit : function(employeeId, employeeName) {
			if(employeeId && employeeName) {
				location.href = ctx + '/sysmgr/category/charge/toAddOrUpdateCategoryCharge?employeeId=' + employeeId + '&employeeName=' + employeeName;
			} else {
				location.href = ctx + '/sysmgr/category/charge/toAddOrUpdateCategoryCharge';
			}
		}
}, VALID_STATUS = 1,
//回车键
...
categoryChargeParam = {type : CATEGORY_ADMINISTRATOR},
