...
<header class="clearfix padding-left-20 padding-right-20">
    <h2 class="logo pull-left">中直采跨境供应链电子商务后台</h2>
        ...
        <li class="ar" id="changePassword"><a href="javascript:void(0)">账号管理</a>
            <ul>
                <li>
                    ...
                    <a href="${ctx}/account/sysmgr/password" id="changePasswordChild" onclick="menu.rememberMenu(event, this);"
