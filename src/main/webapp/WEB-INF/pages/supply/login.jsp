...
<%
    String accountType = AccountTypeEnum.supplier.getCode();
%>
        ...
        <div class="login-shadow">
            <form commandName="user" method="post">
                ...
                <div class="form-group form-code clearfix form-error">
                    ...
                    <img id="imgCaptcha" src="${ctx}/images/kaptcha.jpg" title="" class="pull-left"
                    ...
                    <span class="forget-password text-right margin-bottom-20"><a
                            href="${ctx}/account/password/reset?accountType=2" class="pull-right">忘记密码？ </a></span>
                </div>
    ...
    var login = function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.success) {
                    window.location.href = ctx + '/supply/index';
                } else {
