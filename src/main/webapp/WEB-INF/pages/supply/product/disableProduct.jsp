...
<head>
    ...
    <title>添加商品</title>
    <title>商品库管理-上架商品管理-设置商品下架</title>
</head>
<body>
<!-- 主体切换的内容 -->
<h2 class="title">
    <a class="first">商品库管理</a><a>>上架商品管理</a><a>>设置商品下架</a>
</h2>
                        ...
                        <div class="type-manage">
                            ...
                            <textarea type="text" class="form-control" id="feeLogistics" name="feeLogistics" rows="10"
                                ...
                                <div class="text-center margin-top-30 margin-bottom-10">
                                    <input class="btn btn-info" type="button" id="saveOrUpdateProduct" value="下架并提交审核"/>
                                    <a class="hide open-modal" data-target="#commentModal" id="commentButton"></a>
                                </div>
    <div class="row file-upload text-center margin-left-20 margin-bottom-30">
    <label><span class="caption-14">保存并提交审核后，商品将提交给中直采品类管理员进行审批，审批通过后商品方可下架成功</span></label>
    <label><span class="caption-14">审批通过后商品方可下架成功</span></label>
    </div>
                            </div>
                            <!-------------------------------账号信息end--------------------------------->
                        </div>
    ...
    <div class="modal-content">
        ...
        <div class="margin-right-20 margin-top-10 margin-left-20 margin-bottom-20 clearboth">
            ...
            <div class="row file-upload margin-top-20">
                <label><span class="caption-14">已上架商品，需要下架，请提前三个工作日提交审批（提交审批后的商品，在待审批商品列表中出现）</span></label>
                <label><span class="caption-14">审批通过后商品下架，在审批通过前商品发生订单仍然按照原有信息或价格来操作。</span></label>
            </div>
            <div class="row file-upload margin-top-20 margin-bottom-5">
                <span class="caption-14 imp"><i>*</i>备注信息</span>
            </div>
            <textarea type="text" class="form-control" placeholder="请备注商品下架原因，不超过1000字" rows="10" cols="100%" id="comment"></textarea>
        </div>
...
<script src="${ctx}/resources/script/models/supply/product/disableProduct.js?<%=new Date().getTime()%>"></script>
</body>
</html>