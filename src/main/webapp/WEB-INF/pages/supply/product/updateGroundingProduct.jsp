...
<head>
    ...
    <title>添加商品</title>
    <title>商品库管理-上架商品管理-调整商品信息</title>
</head>
<body>
<!-- 主体切换的内容 -->
<h2 class="title">
    <a class="first">商品库管理</a><a>>上架商品管理</a><a>>调整商品信息</a>
</h2>
                        ...
                        <div class="type-manage">
                            ...
                            <textarea type="text" class="form-control" id="feeLogistics" name="feeLogistics" rows="10"
                                ...
                                <div class="text-center margin-top-30 margin-bottom-30">
                                    <input class="btn btn-info margin-right-10" type="submit" value="保存并提交审批"/>
                                    ...
                                    <div class="row file-upload text-center margin-top-20 margin-left-20 margin-bottom-20">
                                        <label><span class="caption-14">保存并提交审批后，商品将提交给中直采品类管理员进行审批，</span></label>
                                        <label><span class="caption-14">审批通过后，商品方可上架成功。</span></label>
                                    </div>
                                </div>
                            </div>
                            <!-------------------------------账号信息end--------------------------------->
...
<div class="modal" id="commentModal">
    <div class="modal-content">
        ...
        <div class="margin-right-20 margin-top-10 margin-left-20 margin-bottom-20 clearboth">
            ...
            <div class="row file-upload margin-top-20">
                <label><span class="caption-14">已上架商品，需要修改信息、价格，请提前3个工作日提交审批(提交审批后的商品，在待审批商品列表中出现)，</span></label>
                <label><span class="caption-14">审批通过后数据做相应调整，在审批通过前商品发生订单仍然按照原有信息或价格来操作。</span></label>
                <label></label>
            </div>
            <div class="row file-upload margin-top-20 margin-bottom-5">
                <span class="caption-14 imp"><i>*</i>备注信息</span>
            </div>
            <textarea type="text" class="form-control" rows="10" placeholder="请备注哪里做了调整,及调整原因,不超过1000字" cols="100%" id="comment"></textarea>
        </div>
...
<div class="modal" id="">
    <div class="modal-content">
        ...
        <div class="margin-right-20 margin-top-10 margin-left-20 margin-bottom-20 clearboth">
            <h1 class="text-center margin-bottom-20">确认提交审批</h1>
            <div class="row file-upload margin-top-20">
                <label><span class="caption-14">商品调整后，提交审批成功，等待品类管理员审核！</span></label>
                <label><span class="caption-14">此商品审批记录请在<a href="#">［审批管理－已提交商品］</a>中查看，时刻关注商品动态。</span></label>
                <label></label>
            </div>
        </div>
        <div class="text-center margin-top-20">
            <a class="btn btn-danger" id="">关闭</a>
        </div>
    </div>
</div>
...
<script src="${ctx}/resources/script/models/supply/product/updateGroundingProduct.js?<%=new Date().getTime()%>"></script>
</body>
</html>