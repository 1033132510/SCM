...
<div class="container-fluid padding-left-20 padding-right-20 margin-top-20">
    <div class="container-fluid main-info clearfix">
        ...
        <label><span>待处理商品指提交给品类管理员审批中的商品和被部类总监审批不通过打回的商品，等待品类管理员处理操作。</span></label>
        <label><span>待品类管理员审批：指需要品类管理员审批的商品，</span></label>
        <label><span>待品类管理员调整：指部类采购总监审批不通过的商品，需要品类管理员重新调整或退回给供应商重新调整的商品。</span></label>
        </div>
        ...
        <div class="scroll scroll-h">
            <table class="table table-bordered" id="adminPendingGrid" >
                <tr>
...
<script src="${ctx}/resources/script/models/sysmgr/approval/cateAdmin/pending.js"></script>