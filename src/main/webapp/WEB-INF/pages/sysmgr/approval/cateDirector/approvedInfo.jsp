...
<div class="container-fluid padding-left-20 padding-right-20 margin-top-20">
    ...
    <div class="text-center margin-top-30 margin-bottom-30">
        <input class="btn btn-info" type="submit" value="关闭" id="submitButton">
    </div>
</div>
...
<script src="${ctx}/resources/script/models/sysmgr/approval/cateDirector/approvedInfo.js?t="+new Date().valueOf()></script>
