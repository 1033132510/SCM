        ...
        <div class="row margin-top-20">
            <div class="form-group margin-auto">
                ...
                <input type="password" id="oldPassword"
                       class="form-control padding-left-font6 required checkOldPassword"/>
            </div>
        </div>
        <div class="row margin-top-20">
            <div class="form-group margin-auto">
        ...
        <div class="row margin-top-20">
            <div class="form-group margin-auto">
                ...
                <input type="password" id="passwordRepeat"
                       class="form-control padding-left-font7 required validPasswords">
            </div>
        </div>
        <div class="text-center margin-bottom-30">
            <a type="submit" onclick="savePassword();"
               class="btn btn-info margin-top-30 margin-right-10 margin-left-10">提交<a>
        </div>
    </div>
</form>

<br/>
<script src="${ctx}/resources/script/models/account/sysmgr/modifyPassword.js"></script>
</body>
</html>