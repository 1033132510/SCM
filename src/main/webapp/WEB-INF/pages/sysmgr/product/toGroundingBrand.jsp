...
<h2 class="title">
	<a class="first">会员管理</a><a>>品牌管理</a><a>>失效品牌管理</a>
</h2>
<div
	class="container-fluid padding-left-20 padding-right-20 margin-top-20 tab-container ">
	<div class="main-info">
		<h3 class="head">失效品牌管理</h3>
		<form id="grounding_brand_form">
			...
			<div class="tab-content padding-bottom-20 padding-left-20 padding-right-20">
				<div class="tab on">
					...
					<div class="text-center margin-bottom-30">
						<a href="" class="btn btn-info margin-top-30" id="groundingBrand">确认有效</a>
					</div>
				</div>
			</div>
		</form>
...
<script src="${ctx}/resources/script/models/sysmgr/product/toGroundingBrand.js"></script>
<script>
