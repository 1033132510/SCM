    ...
    <div class="container-fluid padding-left-20 padding-right-20 margin-top-20">
        <div class="container-fluid main-info clearfix">
            <div class="type-manage">
                ...
                <div class="padding-top-20 padding-left-20 clearfix">
                    <div class="form-group media pull-left margin-right-25 margin-bottom-20">
...
<script src="${ctx}/resources/script/models/sysmgr/product/updateProduct.js?<%=new Date().getTime()%>"></script>
</body>
</html>