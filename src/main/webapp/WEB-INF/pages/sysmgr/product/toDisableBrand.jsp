		...
		<div class="tab-content padding-bottom-20 padding-left-20 padding-right-20">
			<div class="tab on">
				...
				<div class="row margin-top-20">
					<div class="form-group long pull-left">
						...
						<input type="text" placeholder="请输入公司拥有的品牌名称，字数不超过30" class="form-control padding-left-font6"
							value="${brand.brandZHName}" id="brandview_brandZHName" name="brandview_brandZHName" readonly/>
					</div>
					<div class="form-group long pull-left margin-left-25">
						...
						<input type="text" placeholder="请输入品牌英文名称，如没有填写拼音，字数不超过30" class="form-control padding-left-font6"
							value="${brand.brandENName}" id="brandview_brandENName" name="brandview_brandENName" readonly/>
					</div>
				</div>
				...
				<div class="text-center margin-bottom-30">
					<a class="btn btn-info margin-top-30" id="disableBrand">确认失效</a>
				</div>
			</div>
		</div>
	</div>
...
<script src="${ctx}/resources/script/models/sysmgr/product/toDisableBrand.js"></script>
<script>
