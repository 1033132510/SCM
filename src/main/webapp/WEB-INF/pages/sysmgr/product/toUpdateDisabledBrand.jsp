			...
			<div class="tab-content padding-bottom-20 padding-left-20 padding-right-20">
				<div class="tab on">
					...
					<div class="text-center margin-bottom-30">
						<a class="btn btn-info margin-top-30" id="updateDisabledBrand">保存</a>
					</div>
				</div>
			</div>
		</form>
...
<script src="${ctx}/resources/script/models/sysmgr/product/toUpdateDisabledBrand.js"></script>
<script>
