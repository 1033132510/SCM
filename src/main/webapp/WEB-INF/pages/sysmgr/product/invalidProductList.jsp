...
<div class="container-fluid padding-left-20 padding-right-20 margin-top-20">
    <div class="container-fluid main-info ">
        <div class="search padding-top-10 padding-left-10 padding-right-10 clearfix">
        ...
        <div class="scroll scroll-h">
            <table class="table pinlei" id="productTable">
                ...
                <tr>
                    ...
                    <th w_render="ProductMaintenanceObject.operation" width="15%">操作</th>
                </tr>
                </thead>
            </table>
        </div>
...
<script src="${ctx}/resources/script/models/sysmgr/product/invalidProductList.js?<%=new Date().getTime()%>"></script>
</body>
</html>