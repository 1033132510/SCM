...
<body>
    <h2 class="title"><a class="first">用户管理</a><a>>品类负责人管理</a></h2>
                ...
                <table class="table" id="categoryChargeTable">
                    <thead>
                        <tr>
                            ...
                            <th w_index="modifiedTime" width="20%">配置时间</th>
	...
	<script src="${ctx}/resources/script/models/sysmgr/categoryCharge/categoryChargeList.js?<%=new Date().getTime()%>"></script>
</body>
</html>