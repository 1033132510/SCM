...
<body>
	<h2 class="title"><a class="first">用户管理</a><a>>品类负责人维护</a><a>>添加品类负责人</a></h2>
    ...
    <script src="${ctx}/resources/script/models/sysmgr/categoryCharge/addOrUpdateCategoryCharge.js?<%=new Date().getTime()%>"></script>
</body>
</html>