...
<meta charset="UTF-8">
    ...
    <title>采购商登记信息－登记列表</title>
</head>
<body>

    <h2 class="title"><a class="first">采购商登记信息</a><a>>登记列表</a></h2>
                ...
                <table class="table pinlei" id="registList">
                    <thead>
                        <tr>
                            ...
                            <th w_render="PurchaserObject.getCompanyName" width="25%">公司名称</th>
                            <th w_render="PurchaserObject.getDepartmentName" width="10%">部门</th>
                            <th w_render="PurchaserObject.getPosition" width="8%">职位</th>
                            <th w_index="username" width="7%">姓名</th>
                            <th w_index="mobilePhone" width="10%">手机号</th>
                            <th w_index="idCard" width="10%">身份证号</th>
                            <th w_index="email" width="10%">注册邮箱</th>
	...
	<script src="${ctx}/resources/script/models/sysmgr/purchaser/registList.js?<%=new Date().getTime()%>"></script>
</body>
</html>