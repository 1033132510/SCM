...
<div class="main-content">
    <form class="register" id="supplierForm">
        ...
        <div class="register-input reg-11">
            <input type="text" placeholder="请填写公司所拥有的品牌名称" value="" name="brandName" id="brandName"/>

            <div class="close"></div>
        </div>
        <div class="text-center padding-top-10">
            <button type="submit" class="btn btn-info" id="addSupplier">提交</button>
        </div>
    </form>
</div>
...
<script src="${ctx}/resources/script/models/shop/supplier//addSupplier.js"></script>
</body>
</html>